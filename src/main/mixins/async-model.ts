...
function modifyModel(model) {
	...
	model.count = function(where, cb?) {
		where = (where ? where : {});
		if(cb) return oldModelStatic.count.call(this, where, cb)
		else {
	...
	model.create = function(data, cb?) {
		...
		if(cb) return oldModelStatic.create.call(this, data, cb)
		else {
			return new Promise((resolve, reject) => {
	...
	model.destroyAll = function(where, cb?) {
		where = (where ? where : {})
		if(cb) return oldModelStatic.destroyAll.call(this, where, cb)
		else {
			return new Promise((resolve, reject) => {
	...
	model.destroyById = function(id, cb?) {
		if(cb) return oldModelStatic.destroyById.call(this, id, cb)
		else {
			return new Promise((resolve, reject) => {
	...
	model.exists = function(id, cb?) {
		if(cb) return oldModelStatic.exists.call(this, id, cb)
		else {
			return new Promise((resolve, reject) => {
	...
	model.find = function(filter, cb?) {
		...
		if(cb) return oldModelStatic.find.call(this, filter, cb)
		else {
			return new Promise((resolve, reject) => {
	...
	model.findById = function(id, filter, cb?) {
		filter = (filter ? filter : {})
		if(cb) return oldModelStatic.findById.call(this, id, filter, cb)
		else {
			return new Promise((resolve, reject) => {
	...
	model.findOne = function(filter, cb?) {
		filter = (filter ? filter : {})
		if(cb) return oldModelStatic.findOne.call(this, filter, cb)
		else {
			return new Promise((resolve, reject) => {
	...
	model.findOrCreate = function(filter, data, cb?) {
		filter = (filter ? filter : {})
		if(cb) return oldModelStatic.findOrCreate.call(this, filter, data, cb)
		else {
			return new Promise((resolve, reject) => {
	...
	model.replaceById = function(id, data, options, cb?) {
		if(cb) return oldModelStatic.replaceById.call(this, id, data, options, cb)
		else {
			return new Promise((resolve, reject) => {
	...
	model.replaceOrCreate = function(data, options, cb?) {
		if(cb) return oldModelStatic.replaceOrCreate.call(this, data, options, cb)
		else {
			return new Promise((resolve, reject) => {
	...
	model.updateAll = function(where, data, cb?) {
		where = (where ? where : {})
		if(cb) return oldModelStatic.updateAll.call(this, where, data, cb)
		else {
			return new Promise((resolve, reject) => {
	...
	model.upsert = function(data, cb?) {
		if(cb) return oldModelStatic.upsert.call(this, data, cb)
		else {
			return new Promise((resolve, reject) => {
	...
	model.upsertWithWhere = function(where, data, cb?) {
		where = (where ? where : {})
		if(cb) return oldModelStatic.upsertWithWhere.call(this, where, data, cb)
		else {
			return new Promise((resolve, reject) => {
	...
	model.prototype.destroy = function(cb?) {
		if(cb) return oldModelPrototype.destroy.call(this, cb)
		return new Promise((resolve, reject) => {
	...
	model.prototype.reload = function(cb?) {
		if(cb) return oldModelPrototype.reload.call(this, cb)
		else {
			return new Promise((resolve, reject) => {
	...
	model.prototype.replaceAttributes = function(data, options, cb?) {
		...
		if(cb) return oldModelPrototype.replaceAttributes.call(this, data, options, cb)
		else {
			return new Promise((resolve, reject) => {
	...
	model.prototype.save = function(options, cb?) {
		options = (options ? options : {})
		if(cb) return oldModelPrototype.save.call(this, options, cb)
		else {
			return new Promise((resolve, reject) => {
	...
	model.prototype.updateAttribute = function(name, value, cb?) {
		if(cb) return oldModelPrototype.updateAttribute.call(this, name, value, cb)
		else {
			return new Promise((resolve, reject) => {
	...
	model.prototype.updateAttributes = function(data, cb?) {
		if(cb) return oldModelPrototype.updateAttributes.call(this, data, cb)
		else {
			return new Promise((resolve, reject) => {
